...
public class NoteController {
	...
	*/
	...
	public String saveNote(@ModelAttribute("note1") Note note1, ModelMap model, @RequestParam Integer noteId, @RequestParam String noteTitle, @RequestParam String noteContent, @RequestParam String noteStatus)
	{
	...
	*/
	...
	public String deleteNote(ModelMap model,@RequestParam Integer noteId)
	{
